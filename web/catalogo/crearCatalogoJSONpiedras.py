...
ruta_json = os.path.join(directorio_actual, 'piedras.json')
ruta_csv = os.path.join(directorio_actual, 'piedras.csv')
print(ruta_json)
    ...
    for fila in lector_csv:
        ...
        try:
            ...
            if len(fila) == 3:
                ...
                prod= {}
                prod["id_piedra"] = id_piedra,    # id
                prod["piedra"] = fila[1],    # tipo
                prod["Explicacion"] = fila[2],    # nombre
